      ...
      <div className="flex-1 bg-gradient-hero relative overflow-hidden">
        ...
        <div className="container max-w-lg mx-auto px-4 pt-16 pb-8 relative">
          <motion.div
            ...
            className="w-24 h-24 bg-card rounded-3xl mx-auto mb-6 flex items-center justify-center shadow-elevated"
          >
          ...
          <motion.h1
            ...
            className="text-4xl font-bold text-center text-primary-foreground mb-3"
          >
            Rafiq Nihon
          </motion.h1>
